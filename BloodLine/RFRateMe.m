...
#define kAppStoreAddressFor7Above [NSString  stringWithFormat:@"itms-apps://itunes.apple.com/app/id%d",YOUR_APP_STORE_ID];
#define kAppStoreAddressBelow7 [NSString  stringWithFormat:@"itms-apps://itunes.apple.com/WebObjects/MZStore.woa/wa/viewContentsUserReviews?id=%@&onlyLatestVersion=true&pageNumber=0&sortOrdering=1&type=Purple+Software",YOUR_APP_STORE_ID];

#define kAppName @"BloodRegistry"
        ...
        switch (buttonIndex) {
            ...
            case 1:
                ...
                if ([[UIDevice currentDevice].systemVersion integerValue] > 6)
                    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:[NSString  stringWithFormat:@"itms-apps://itunes.apple.com/app/id%d",YOUR_APP_STORE_ID]]];
                else
                   [[UIApplication sharedApplication] openURL:[NSURL URLWithString:[NSString  stringWithFormat:@"itms-apps://itunes.apple.com/WebObjects/MZStore.woa/wa/viewContentsUserReviews?id=%d&onlyLatestVersion=true&pageNumber=0&sortOrdering=1&type=Purple+Software",YOUR_APP_STORE_ID]]];
